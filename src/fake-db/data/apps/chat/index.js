  ...
  contacts: [
    {
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-1.png'),
      status: 'offline'
    },
    {
      uid: 2,
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-2.png'),
    ...
    },
    {
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-3.png'),
      status: 'do not disturb'
    },
    {
      uid: 4,
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-4.png'),
      status: 'online'
    },
    {
      uid: 5,
    ...
    },
    {
      ...
      about:
        'Toffee caramels jelly-o tart gummi bears cake I love ice cream lollipop. Sweet liquorice croissant candy danish dessert icing. Cake macaroon gingerbread toffee sweet.',
      photoURL: require('@/assets/images/portrait/small/avatar-s-6.png'),
      status: 'online'
    },
    {
      uid: 7,
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-7.png'),
      status: 'online'
    },
    {
      uid: 8,
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-8.png'),
      status: 'away'
    },
    {
      uid: 9,
      ...
      photoURL: require('@/assets/images/portrait/small/avatar-s-9.png'),
      status: 'offline'
    },
    {
      uid: 10,
      ...
      about:
        'Cake pie jelly jelly beans. Marzipan lemon drops halvah cake. Pudding cookie lemon drops icing',
      photoURL: require('@/assets/images/portrait/small/avatar-s-10.png'),
      status: 'away'
    }
  ],
  chats: {
