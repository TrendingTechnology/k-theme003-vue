export default {
  ...
  data: [
    ...
    {
      index: 44,
      label: 'Switch Form Element',
      url: '/forms/form-elements/switch',
      labelIcon: 'ToggleLeftIcon',
      highlightAction: false
    },
    {
      index: 45,
    ...
    {
      index: 48,
      label: 'Number Input Form Element',
    ...
    {
      index: 62,
      label: 'Not Authorized Page',
      url: '/pages/not-authorized',
      labelIcon: 'XCircleIcon',
      highlightAction: false
    },
    {
      index: 63,
