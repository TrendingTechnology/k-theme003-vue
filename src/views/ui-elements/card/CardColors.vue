  ...
  <div class="vx-row">
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      ...
      >
        <p class="mb-3">
          You can use
          <code>subtitle-color</code> prop to change color of subtitle of card. This prop supports hex, rgba, rgb and theme colors.
        </p>
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      ...
      >
        <p class="mb-3">
          You can use
          <code>content-color</code> prop to change color of title of card. This prop supports hex, rgba, rgb and theme colors.
        </p>
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      ...
      >
        <p class="mb-3">
          You can use
          <strong>card-background</strong> prop to change background color of card. This prop supports hex, rgba, rgb and theme colors.
        </p>
        <p
          class="mb-3"
        >Oat cake powder sesame snaps. Chocolate bar dessert bonbon chocolate bar pudding apple pie muffin chocolate ice cream. I love bear claw I love.</p>
    ...
    <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
      ...
      >
        <p class="mb-3">
          You can use
          <strong>card-background</strong> prop to change background of card. This prop supports hex, rgba, rgb and theme colors.
        </p>
        <p
          class="mb-3"
        >Oat cake powder sesame snaps. Chocolate bar dessert bonbon chocolate bar pudding apple pie muffin chocolate ice cream. I love bear claw I love.</p>
