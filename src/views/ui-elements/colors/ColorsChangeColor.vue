<template>
  <vx-card title="Change Color" code-toggler>
    ...
    <p class="mt-5">
      By doing this, all
      <strong>Vuesax</strong> components and other components which uses primary color in the application will change. Select one of the colors to change it and that all the components of this application will have that color.
    </p>
