<template>
  <vx-card title="Design Concept" code-toggler>
    <p>
      With the directive
      <code>vs-w</code> define the width of the column (
      <code>vs-col</code>) its value is
      <strong>1-12</strong> an example of sizes would be:
      <strong>12 = 100%, 6 = 50%, 4 = 25%</strong>
    </p>
