<template>
  <vx-card title="Column Order" code-toggler>
    <p>
      Use
      <code>flex-row-reverse</code> to reverse column order. Useful for two-column responsive layouts where the column on right should appear first on smaller screens
    </p>
