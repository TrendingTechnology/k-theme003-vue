<template>
  <vx-card title="SSR" code-toggler>
    <p>
      To create table with SSR support just add
      <code>sst</code> prop and then handle appropriate events like searching, sorting & pagination.
    </p>
    ...
    <prism class="rounded-lg">{{ log.join("\n") }}</prism>
