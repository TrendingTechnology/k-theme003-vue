<template>
  <vx-card title="Single Selected" code-toggler>
    <p>
      You can add the functionality of select a specific
      <strong>tr</strong> to do this add the property
      <code>data</code> with the value to be selected, it is usually the triterated
    </p>
    ...
    <vs-alert color="primary" icon="new_releases" active="true" class="mt-3">
      <p>
        ...
        <code>@selected</code>, as the first parameter the data is returned
      </p>
    </vs-alert>
    <br />
