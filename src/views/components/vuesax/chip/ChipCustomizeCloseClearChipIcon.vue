<template>
  <vx-card title="Customize Close and Clear Chips Icons" code-toggler>
    ...
    <template slot="codeContainer">
      ...
      remove-icon=&quot;delete_forever&quot;&gt; &lt;vs-chip
      :key=&quot;chip&quot; @click=&quot;remove(chip)&quot; v-for=&quot;chip in
      chips&quot; closable close-icon=&quot;delete&quot;&gt;
      {{ "\{\{ chip \}\}" }}
      &lt;/vs-chip&gt; &lt;/vs-chips&gt; &lt;/template&gt; &lt;script&gt; export
      default { data(){ return { chips:[ &apos;Dribbble&apos;,
      &apos;GitHub&apos;, &apos;Behance&apos;, &apos;Vuejs&apos;,
      &apos;Kdev&apos;, ], } }, methods: { remove (item) {
...
export default {
  data() {
    return {
      chips: ["Dribbble", "GitHub", "Behance", "Vuejs", "Kdev"]
    };
  },
  methods: {
    remove(item) {
