  ...
  <vx-card class="list-view-item mb-base overflow-hidden">
    <template slot="no-body">
      <div class="vx-row item-details no-gutter">
        <!-- IMG COL -->
        <div
          class="vx-col sm:w-1/4 w-full item-img-container bg-white flex items-center justify-center"
        >
        ...
        <div class="vx-col sm:w-1/2">
          <div class="p-4 pt-6">
            <slot name="item-meta">
              ...
              <p class="text-sm mb-4 cursor-pointer">
                By
                <span class="text-primary font-semibold">{{ item.brand }}</span>
              </p>
        ...
        <!-- PURCHASE COL -->
        <div
          class="vx-col sm:w-1/4 w-full flex items-center border border-solid d-theme-border-grey-light border-r-0 border-t-0 border-b-0"
        >
